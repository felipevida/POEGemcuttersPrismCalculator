...
# INFO
#
# This calulcator aims to help Path of Exile players decision making when doing Gemcutter's Prism (GCP) vendor recipe.
# In Path of Exile there is no money like gold, instead the currency of the game is based on items that helps players on crafting weapons
# and gear. There are lots of different recipes in this game that are based on this same principle, however a GCP's value has a significant
# weight if a player manage to use this recipe with maximum efficiency.
#
#
...
#
# Bellow are some study cases demonstrating how results are expected to be shown:
#
...
#  Also, I'm going to open a branch with the current GUI I'm wrote using javax.swing library.
#
